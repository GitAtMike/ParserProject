...
class PyGrammarOneParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "MOD", "VARNAME", "INT", "FLOAT", "STRING", "NEWLINE", 
                      "WHITESPACE" ]
    ...
    ruleNames =  [ "prog", "exp", "types", "assign", "arith", "array" ]
    ...
    class ProgContext(ParserRuleContext):
        ...
        def exp(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PyGrammarOneParser.ExpContext)
            else:
                return self.getTypedRuleContext(PyGrammarOneParser.ExpContext,i)
    ...
    def prog(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << PyGrammarOneParser.T__0) | (1 << PyGrammarOneParser.VARNAME) | (1 << PyGrammarOneParser.INT) | (1 << PyGrammarOneParser.FLOAT) | (1 << PyGrammarOneParser.STRING))) != 0):
                self.state = 12
                self.exp()
                self.state = 13
    ...
    class ExpContext(ParserRuleContext):
        ...
        def types(self):
            return self.getTypedRuleContext(PyGrammarOneParser.TypesContext,0)


        def getRuleIndex(self):
            return PyGrammarOneParser.RULE_exp
    ...
    def exp(self):
        ...
        localctx = PyGrammarOneParser.ExpContext(self, self._ctx, self.state)
    ...
    class TypesContext(ParserRuleContext):
        ...
        def VARNAME(self):
            return self.getToken(PyGrammarOneParser.VARNAME, 0)

        def getRuleIndex(self):
            return PyGrammarOneParser.RULE_types
    ...
    def types(self):
        ...
        localctx = PyGrammarOneParser.TypesContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_types)
        try:
            self.state = 32
            self._errHandler.sync(self)
            ...
            if token in [PyGrammarOneParser.INT]:
                ...
                self.array()
                pass
            elif token in [PyGrammarOneParser.VARNAME]:
                self.enterOuterAlt(localctx, 5)
                self.state = 31
                self.match(PyGrammarOneParser.VARNAME)
                pass
            else:
    ...
    class AssignContext(ParserRuleContext):
        ...
        def exp(self):
            return self.getTypedRuleContext(PyGrammarOneParser.ExpContext,0)
    ...
    class ArithContext(ParserRuleContext):
        ...
        def types(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PyGrammarOneParser.TypesContext)
            else:
                return self.getTypedRuleContext(PyGrammarOneParser.TypesContext,i)
    ...
    def array(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << PyGrammarOneParser.T__0) | (1 << PyGrammarOneParser.VARNAME) | (1 << PyGrammarOneParser.INT) | (1 << PyGrammarOneParser.FLOAT) | (1 << PyGrammarOneParser.STRING))) != 0):
                self.state = 47
                self.types()
                self.state = 52
                self._errHandler.sync(self)
